      ...
      <div className="container-shell space-y-8">
        <section className="panel rounded-[var(--radius-xl)] border border-mint/20 px-6 py-10 md:px-10 md:py-14">
          <div className="mx-auto max-w-4xl space-y-6 text-center">
            ...
            {params.email ? <p className="text-sm text-muted">Receipt/delivery contact: {params.email}</p> : null}
          </div>
        </section>
        ...
        <section className="grid gap-5 lg:grid-cols-[1fr_0.9fr]">
          <article className="panel rounded-[var(--radius-xl)] p-6 md:p-8">
            ...
            <div className="mt-5 space-y-4">
              {offer.deliveryAssets.length ? (
                ...
                <p className="leading-7 text-foreground-soft">No file download is needed here. This purchase should trigger access provisioning and onboarding automation.</p>
              )}
            </div>
          </article>
          ...
          <aside className="panel rounded-[var(--radius-xl)] border border-orange/30 p-6 md:p-8">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-tight text-cream">{offer.handoffTarget === "lab" ? "Move them into Lab onboarding." : "Keep momentum with the next offer."}</h2>
            <p className="mt-4 leading-7 text-foreground-soft">
              {offer.handoffTarget === "lab"
                ? "This success state is ready for post-purchase tagging and Lab enrollment follow-up. Wire your automation platform or membership system to provision access here."
